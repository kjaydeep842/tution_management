...
<head>
    ...
    <style>
        ...
        .message { background: #fffbeb; border-left: 4px solid #f59e0b; padding: 16px; border-radius: 8px; margin: 24px 0; font-size: 14px; color: #374151; line-height: 1.6; }
...
<body>
    <div class="wrapper">
        <div class="header">
            ...
            <p>Your child was marked Late today</p>
        </div>
        <div class="body">
            ...
            <div class="info-row"><span class="label">Status</span><span class="value" style="color:#f59e0b;">Late</span></div>

            <div class="message">
                Dear Parent/Guardian,<br><br>
                This is to inform you that <strong>{{ $student->full_name }}</strong> was marked <strong>Late</strong> on <strong>{{ \Carbon\Carbon::parse($date)->format('d M Y') }}</strong> for the class <strong>{{ $className }}</strong>.<br><br>
                Please ensure that the student arrives on time for future classes.
            </div>
        </div>
        <div class="footer">
