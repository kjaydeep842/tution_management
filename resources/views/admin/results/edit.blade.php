<x-admin-layout>
    <div style="margin-bottom:28px; display:flex; justify-content:space-between; align-items:center;">
        <div>
            <h1 style="font-size:26px; font-weight:800; color:#0f172a; margin:0 0 4px;">Edit Student Result</h1>
            <p style="color:#64748b; font-size:14px; margin:0;">Modify success story details.</p>
        </div>
    ...
    <form action="{{ route('results.update', $result) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex flex-col gap-4">
                    <div>
                        ...
                        <input type="text" name="student_name" class="input-field" required
                            value="{{ old('student_name', $result->student_name) }}" placeholder="e.g. Rahul Sharma">
                    ...
                    <div>
                        ...
                        <input type="text" name="exam_name" class="input-field" required
                            value="{{ old('exam_name', $result->exam_name) }}" placeholder="e.g. SSC Board 2024">
                    ...
                    <div>
                        ...
                        <input type="text" name="marks_percentage" class="input-field" required
                            value="{{ old('marks_percentage', $result->marks_percentage) }}" placeholder="e.g. 96.5%">
                    ...
                    <div>
                        ...
                        <input type="text" name="achievement" class="input-field"
                            value="{{ old('achievement', $result->achievement) }}"
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div>
                        <label class="flex items-center gap-2 cursor-pointer mt-4">
                            <input type="checkbox" name="is_active" value="1" {{ old('is_active', $result->is_active) ? 'checked' : '' }}
        ...
        <div class="flex gap-4">
            <button type="submit" class="btn-primary">Update Result Story</button>
