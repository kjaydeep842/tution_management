<x-admin-layout>
    ...
    <div style="max-width:700px;">
        <div style="margin-bottom:28px;">
            <h1 style="font-size:26px; font-weight:800; color:#0f172a; margin:0 0 4px;">Add New Teacher</h1>
            <p style="color:#64748b; font-size:14px; margin:0;">Add a teacher to your staff</p>
        </div>
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:20px;">
                        ...
                        <div class="ms-wrapper" id="subject-ms">
                            ...
                            <div class="ms-dropdown">
                                ...
                                @foreach($subjects as $subject)
                                    <label class="ms-option{{ in_array($subject, old('subjects', [])) ? ' selected' : '' }}"
                                        data-value="{{ $subject }}">
                                        <input type="checkbox" name="subjects[]" value="{{ $subject }}" {{ in_array($subject, old('subjects', [])) ? 'checked' : '' }}
                    ...
                    <div style="grid-column:1/3;">
                        <label
                            ...
                            to Branch <span style="font-weight:400; color:#94a3b8;">(select one or more)</span></label>
                        <div class="ms-wrapper" id="branch-ms">
                            ...
                            <div class="ms-dropdown">
                                @foreach($branches as $branch)
                                    <label
                                        class="ms-option{{ in_array($branch->id, old('branch_ids', [])) ? ' selected' : '' }}"
