<x-admin-layout>
    <div style="margin-bottom:28px; display:flex; justify-content:space-between; align-items:center;">
        <div>
            <h1 style="font-size:26px; font-weight:800; color:#0f172a; margin:0 0 4px;">Add New Parent</h1>
            <p style="color:#64748b; font-size:14px; margin:0;">Create a new parent account and link it to students.</p>
        </div>
    ...
    <form action="{{ route('admin.parents.store') }}" method="POST">
            ...
            <div style="display:flex; flex-direction:column; gap:24px;">
                <div class="card">
                    ...
                    <div style="display:flex; flex-direction:column; gap:16px;">
                        <div>
                            <label
                                style="display:block; font-size:13px; font-weight:600; color:#374151; margin-bottom:6px;">Password</label>
                            <input type="password" name="password" class="input-field"
                                placeholder="Leave blank to auto-generate">
                            <p style="color:#64748b; font-size:11px; margin-top:4px;">If left blank, a random password
                ...
                <div class="card">
                    ...
                    <div>
                        ...
                        <div
                            ...
                            @empty
                                <p style="font-size:13px; color:#64748b; font-style:italic;">No unlinked students available.
                                </p>
                            @endforelse
                        </div>
        ...
        <div style="display:flex; gap:12px;">
            <button type="submit" class="btn-primary">Create Parent Account</button>
